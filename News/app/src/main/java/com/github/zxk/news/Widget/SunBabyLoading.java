...
/**
 * Created by 庄欣锴zz on 2016/7/5.
 * 自定义LoadingView
 */
public class SunBabyLoading extends View {
    ...
    public SunBabyLoading(Context context) {
        this(context, null);
    }

    public SunBabyLoading(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SunBabyLoading(Context context, AttributeSet attrs, int defStyle) {
